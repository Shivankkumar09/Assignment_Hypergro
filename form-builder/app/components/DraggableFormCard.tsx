...
export default function DraggableFormCard({ field, onUpdate, onDelete }: Props) {
  ...
  return (
   <div ref={setNodeRef} style={style} className="relative group border rounded-md bg-white dark:bg-gray-800 shadow mb-4">
  <div
    {...listeners}
    {...attributes}
